...
public abstract class SkeinforgeGenerator extends ToolpathGenerator {
	...
	protected class SkeinforgeChoicePreference implements SkeinforgePreference {
		...
		SkeinforgeChoicePreference(String name, String materialProperty, final String preferenceName, String defaultState, String toolTip) {
		...
		public List<SkeinforgeOption> getOptions() {
			...
			{
				return optionsMap.get(material.get(this.materialProperty));
			}
